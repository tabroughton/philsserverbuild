...
#################################################################
# script to update the lan if ip range changes etc	        #
# 							        #
# - identifies ip addresses possible			        #
# - identifies possible interface			        #
# - updates all nececessary ip address settings		        #
# - informs user what to next, manual steps required afterwards #
#################################################################
